...
PyPDFForm version 3.0.0 is tentatively scheduled to be released on June 24, 2025. This major release will contain changes that are backward incompatible. If you do not wish to trigger any downstream regression, pin your version to 2.5.0 or lower ASAP.
...
In short, the goal of version 3.0.0 can be summed up to:
