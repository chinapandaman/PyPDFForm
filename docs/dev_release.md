...
1. A [version bump commit](https://github.com/chinapandaman/PyPDFForm/commit/97ccaa34e7ee48d69fd3807ccd93c0af5ef8869d) that bumps the version and formats the codebase with [ruff](https://docs.astral.sh/ruff/).
